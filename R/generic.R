...
#' corresponding \code{plot} method is used by \code{plot.bootstrap_f2()}.
#' Arguments to the \code{\link[boot]{plot.boot}()} function can be passed via
#' the \code{...} parameter. In addition to making the plot the function prints
#' the result of Shah's lower 90\% BCa confidence interval to the console.
#'
...
#' methods are used by \code{summary.bootstrap_f2()}. Arguments to the
